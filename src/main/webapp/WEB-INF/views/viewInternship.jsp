<%-- viewInternship.jsp (UPDATED with Dashboard Styling) --%>
...
<head>
  ...
  <style>
    ...
    * {
    ...
    .employer-info div[style*="margin-top"] {
        color: var(--pure-white) !important;
        margin-top: 0.5rem;
    }

    .employer-info div[style*="color: #5e7fa3"] {
    ...
    p[style*="color: #1d405c; line-height: 1.7; background: #f8fcff; padding: 1.5rem; border-radius: 20px;"] {
...
<body>
  ...
  <div class="dashboard-layout" id="dashboardLayout">
    ...
    <aside class="nav-sidebar" id="mainSidebar">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="dashboard"><i class="bi bi-graph-up"></i> <span>Overview</span></a></li>
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="listInternship"><i class="bi bi-list-ul"></i> <span>All Internships</span></a></li>
    ...
    <!-- ========== MAIN PANEL - VIEW INTERNSHIP CONTENT (UNTOUCHED LOGIC) ========== -->
    <main class="main-panel" id="mainPanel">
      
      <!-- Page Header with Back Button -->
      <div class="page-header">
        <div class="d-flex align-items-center gap-3">
          <a href="listInternship" class="btn-back">
      ...
      <c:choose>
        <c:when test="${empty internship}">
          <div class="not-found">
            ...
            <h3 class="mt-3">Internship Not Found</h3>
            <p class="text-muted">The internship you're looking for doesn't exist or has been deleted.</p>
            <a href="listInternship" class="btn-back mt-3">Return to List</a>
          </div>
        </c:when>
        <c:otherwise>
          <div class="detail-card">
            <!-- Basic Information Section with Internship ID prominently displayed -->
            <div class="info-note">
              <i class="bi bi-info-circle"></i> 
              <strong>Internship ID:</strong> ${internship.internshipId}
            </div>
            ...
            <div class="detail-section">
              ...
              <div class="detail-grid">
                <div class="detail-item">
                  ...
                  <span class="detail-value">${internship.title}</span>
                </div>
                <div class="detail-item">
                  <span class="detail-label">Type</span>
                  <span class="detail-value">${internship.internshipType}</span>
                </div>
			    ...
			    <div class="detail-item">
			      ...
			      <span class="detail-value">
			        <i class="bi bi-geo-alt" style="color: var(--bright-blue); margin-right: 5px;"></i>
			        ${internship.location}
			      </span>
			    </div>
                ...
                <div class="detail-item">
                  ...
                  <span class="detail-value">${internship.durationMonths} months</span>
                </div>
                <div class="detail-item">
                  <span class="detail-label">Openings</span>
                  <span class="detail-value">${internship.openings} positions</span>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                  ...
                  <span class="detail-value">
                    <c:choose>
                      <c:when test="${internship.isPaid}">
                        <span class="paid-badge"><i class="bi bi-cash"></i> PAID</span>
                      </c:when>
                      <c:otherwise>
                        <span class="unpaid-badge"><i class="bi bi-clock"></i> UNPAID</span>
                      </c:otherwise>
                    </c:choose>
                  </span>
                </div>
                  ...
                  <span class="detail-value">
                    <c:choose>
                      <c:when test="${internship.status eq 'OPEN'}">
                        <span class="badge-detail-status status-open">OPEN</span>
                      </c:when>
                      
                      <c:when test="${internship.status eq 'UPCOMING'}">
            <span class="badge-detail-status status-upcoming">UPCOMING</span>
          </c:when>
                      
                      <c:otherwise>
                        <span class="badge-detail-status status-closed">CLOSED</span>
                      </c:otherwise>
                    </c:choose>
                  </span>
                </div>
            ...
            <!-- Employer Information Section (with the requested format) -->
            <div class="detail-section">
              <div class="detail-section-title">
              ...
              <div class="employer-info">
                ...
                <div class="employer-id">
                  Employer ID: ${internship.employer.employerId}
                </div>
                <c:if test="${not empty internship.employer.hrName}">
                  <div style="margin-top: 0.5rem; color: var(--pure-white);">
                    <i class="bi bi-person"></i> HR: ${internship.employer.hrName}
                  </div>
                </c:if>
                <c:if test="${not empty internship.employer.companyType}">
                  <div style="color: var(--soft-blue); font-size: 0.9rem;">
                    <i class="bi bi-tag"></i> ${internship.employer.companyType}
                  </div>
                </c:if>
              </div>
            </div>
            ...
            <div class="detail-section">
              ...
              <div class="detail-grid">
                <div class="detail-item">
                  ...
                  <span class="detail-value">${internship.startDate}</span>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                  ...
                  <span class="detail-value">${internship.createdAt}</span>
                </div>
              </div>
            </div>
			...
			<div class="detail-section">
			    <div class="detail-section-title">
			        <i class="bi bi-gear"></i> Skills Required
			    </div>
			    <p style="color: var(--text-secondary); line-height: 1.7; background: rgba(255, 255, 255, 0.05); padding: 1.5rem; border-radius: 20px; border: 1px solid var(--border-blue);">

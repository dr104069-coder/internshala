...
<head>
    ...
    <title>Employer Management · SmartIntern Admin</title>
...
<link rel="stylesheet" href="https://cdn.datatables.net/1.13.6/css/dataTables.bootstrap5.min.css">
    ...
    <style>
        ...
        * {
        ...
        /* ========================================================
           EMPLOYER LIST CONTAINER - MATCHING DASHBOARD STYLE
           ======================================================== */
        .employer-container {
            background: var(--glass-deep);
            backdrop-filter: blur(12px);
    ...
    <div class="dashboard-layout" id="dashboardLayout">
        ...
        <aside class="nav-sidebar" id="mainSidebar">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/listEmployer"><i class="bi bi-check-circle"></i> <span>Employers</span></a></li>
                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/employer"><i class="bi bi-plus-circle"></i> <span>Add Employer</span></a></li>
                </ul>
            </div>
        ...
        <!-- MAIN PANEL - EMPLOYER MANAGEMENT CONTENT (UNTOUCHED LOGIC) -->
        <main class="main-panel">

            <!-- Header with Back Button and Add Employer Button -->
           <!-- Header with Back Button, Report Dropdown and Add Employer Button -->
<div class="header-with-back">
    <div style="display: flex; gap: 1rem;">
        ...
        <a href="/employer" class="btn-add-employer">
            ...
            <div class="employer-container">
                ...
                <!-- card header with title and total badge -->
                <div class="employer-header">
                    ...
                    <span class="total-badge">
                        <i class="bi bi-people-fill"></i> Total: ${employerList.size()}
                    </span>
                </div>

                <!-- card body with table - 100% original business logic, untouched -->
                <div class="employer-body">
                    <div class="table-responsive">
                       <table id="employersTable" class="table table-hover align-middle">
                            <thead>
                                <tr>
                                    <th>SR NO</th>
                                    <th>Company Name</th>
    ...
    <tr>
        ...
        <td>${e.companyType}</td>
        <td>
            <a href="${e.website}" target="_blank" class="company-link">
        ...
        <td>
            <div class="action-btns">
                <!-- View Button -->
                <a href="viewEmployer?employerId=${e.employerId}" class="btn-sm btn-primary">
                    <i class="bi bi-eye-fill"></i> View
                </a>
                
                <!-- Edit Button - FIXED: use ${e.employerId} not ${employer.employerId} -->
                <a href="${pageContext.request.contextPath}/editemployer?employerId=${e.employerId}" 
   ...
   <script>
    (function() {
        ...
        $(document).ready(function() {
            if ($('#employersTable').length > 0 && $('#employersTable tbody tr').length > 0) {
        ...
        toggleBtn.addEventListener('click', function(e) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#employersTable')) {
                    $('#employersTable').DataTable().columns.adjust().draw();
                }
            }, 300);
        });
        ...
        function getEmployerData() {
            var data = [['SR NO', 'COMPANY NAME', 'COMPANY TYPE', 'WEBSITE']];
            
            // Get all rows from the table body
            var rows = document.querySelectorAll('#employersTable tbody tr');
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                if (cells.length >= 4) {
                    ...
                    // Get Company Name
                    var companyName = cells[1] ? cells[1].innerText.trim() : '';
                    
                    // Get Company Type
                    var companyType = cells[2] ? cells[2].innerText.trim() : '';
                    
                    // Get Website (extract from link)
                    var website = '';
                    if (cells[3]) {
                        var link = cells[3].querySelector('a');
                        if (link) {
                            website = link.innerText.trim();
                        } else {
                            website = cells[3].innerText.trim();
                        }
                    }
                    
                    data.push([srNo, companyName, companyType, website]);
                }
            }
            return data;
        }
        ...
        function exportToPDF() {
            ...
            var html = '<!DOCTYPE html><html><head><title>Employers Report</title><style>';
            ...
            html += '<h1>SmartIntern - Employers Report</h1>';
            html += '<p>Generated on: ' + new Date().toLocaleString() + '</p>';
            html += '<p>Total Employers: ' + (data.length - 1) + '</p>';
            html += '</div>';
        ...
        function exportToExcel() {
            ...
            var html = '<html><head><meta charset="UTF-8"><title>Employers Report</title></head><body>';
            html += '<table border="1">';
            ...
            link.download = 'Employers_Report_' + new Date().toISOString().slice(0,10) + '.xls';
            link.click();
        ...
        function exportToCSV() {
            ...
            var link = document.createElement('a');
            link.href = URL.createObjectURL(blob);
            link.download = 'Employers_Report_' + new Date().toISOString().slice(0,10) + '.csv';
            link.click();
            URL.revokeObjectURL(link.href);
        }
        ...
        function exportToWord() {
            ...
            var html = '<html><head><meta charset="UTF-8"><title>Employers Report</title>';
            ...
            var link = document.createElement('a');
            link.href = URL.createObjectURL(blob);
            link.download = 'Employers_Report_' + new Date().toISOString().slice(0,10) + '.doc';
            link.click();
            URL.revokeObjectURL(link.href);
        }
        ...
        function printReport() {
            ...
            var win = window.open('', '_blank');
            var html = '<html><head><title>Print Employers Report</title>';
            html += '<style>';

...
<head>
    ...
    <title>Add Internship · SmartIntern Admin</title>
...
<body>
    ...
    <div class="dashboard-layout" id="dashboardLayout">
        ...
        <!-- MAIN PANEL - ADD INTERNSHIP CONTENT (UNTOUCHED LOGIC) -->
        <main class="main-panel">
            ...
            <div class="form-card">
                ...
                <div class="form-header">
                    ...
                    <h3 class="section-title">Create Internship Posting</h3>
                    <p class="section-sub">Fill in the details below to create a new internship opportunity</p>
                </div>

                <!-- Form - ALL FIELDS EXACTLY THE SAME, just colors changed -->
               <form action="saveInternship" method="post" enctype="multipart/form-data">
                    <!-- Basic Information -->
                    ...
                    <div class="form-row">
                        <div class="input-group-custom">
                            <label><i class="bi bi-briefcase"></i> Internship Title</label>
                            <input type="text" name="title" class="form-control" placeholder="e.g. Full Stack Developer Intern" required>
                        </div>

                        <div class="input-group-custom">
                            <label><i class="bi bi-tags"></i> Internship Type</label>
						...
						<!-- Add Location Field Here -->
							<div class="form-row">
							    <div class="input-group-custom full-width">
							        ...
							        <input type="text" name="location" class="form-control" placeholder="e.g. New York, NY or Remote" required>
							    </div>
							</div>
                    ...
                    <!-- Duration & Stipend -->
                    <div class="form-section-title">
                        <i class="bi bi-clock"></i> Duration & Stipend
                    </div>

                    <div class="form-row">
                        <div class="input-group-custom">
                            <label><i class="bi bi-calendar"></i> Duration (Months)</label>
                            <input type="number" name="durationMonths" class="form-control" min="1" placeholder="e.g. 3">
                        </div>

                        <div class="input-group-custom">
                            <label><i class="bi bi-cash"></i> Monthly Stipend (₹)</label>
                            <input type="number" step="0.01" name="stipend" class="form-control" placeholder="e.g. 15000">
                        </div>

                        <div class="input-group-custom">
                            <label><i class="bi bi-people"></i> Openings</label>
                            <input type="number" name="openings" class="form-control" placeholder="e.g. 5">
                        </div>
                    </div>

                    <div class="form-row">
                        <div class="input-group-custom full-width">
                            <label><i class="bi bi-gear"></i> Skills Required</label>
                    ...
                    <div class="form-row">
                        <div class="input-group-custom">
                            <label><i class="bi bi-calendar"></i> Start Date</label>
                    ...
                    <div class="form-row">
                        <div class="input-group-custom">
                            <label><i class="bi bi-cash"></i> Is Paid?</label>
					...
					<div class="form-section-title">
					    <i class="bi bi-image"></i> Internship Poster
					</div>
					
					<div class="form-row">
					    <div class="input-group-custom full-width">
					        <label><i class="bi bi-upload"></i> Upload Poster</label>

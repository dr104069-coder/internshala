...
<head>
    ...
    <title>Edit Employer · SmartIntern Admin</title>
...
<body>
            ...
            <div class="edit-card">
                ...
                <div class="card-header-custom">
                    <div>
                        ...
                        <p><i class="bi bi-info-circle me-1"></i> Update the company information below</p>
                    </div>
                    <a href="listEmployer" class="btn-back">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="info-label">
                                <i class="bi bi-person-badge me-1"></i>Employer ID
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="info-label">
                                <i class="bi bi-person me-1"></i>Associated User
                            </div>
                            <div class="info-value">
                                <i class="bi bi-person-circle"></i>
                                <c:if test="${not empty employer.user}">
                                    ${employer.user.firstName} ${employer.user.lastName} (${employer.user.email})
                                </c:if>
                                <c:if test="${empty employer.user}">
                ...
                <!-- Edit Form - posts to updateEmployer -->
                <form action="updateEmployer" method="post">
                    
                    <!-- Hidden field for employerId -->
                    ...
                    <div class="mb-4">
                        ...
                        <select name="companyType" class="form-select-custom" required>
                            ...
                            <option value="Startup" ${employer.companyType == 'Startup' ? 'selected' : ''}>🚀 Startup</option>
                            <option value="MNC" ${employer.companyType == 'MNC' ? 'selected' : ''}>🌍 MNC</option>
                            <option value="Private Ltd" ${employer.companyType == 'Private Ltd' ? 'selected' : ''}>🏢 Private Ltd</option>
                            <option value="Government" ${employer.companyType == 'Government' ? 'selected' : ''}>🏛️ Government</option>
                            <option value="NGO" ${employer.companyType == 'NGO' ? 'selected' : ''}>❤️ NGO</option>
                            <option value="Other" ${employer.companyType == 'Other' ? 'selected' : ''}>📌 Other</option>
                        </select>
                    </div>
                    ...
                    <!-- Verified Status (Admin only - optional) -->
                    <div class="mb-4">
                        <label class="form-label-custom">
                            <i class="bi bi-shield-check"></i>
                            Verification Status
                        </label>
                        <select name="companyVerified" class="form-select-custom">
                            <option value="false" ${!employer.companyVerified ? 'selected' : ''}>❌ Not Verified</option>
                            <option value="true" ${employer.companyVerified ? 'selected' : ''}>✅ Verified</option>
                        </select>
                        <div class="info-text-custom">
                            <i class="bi bi-info-circle"></i>
                            Mark as verified after reviewing company documents
                        </div>
                    </div>
                    ...
                    <div class="row mt-5 g-3">
                        ...
                        <div class="col-md-6">
                            <a href="listEmployer" class="btn-cancel w-100 text-center">
    ...
    <footer class="dashboard-footer">
        2026 SmartIntern — Edit Employer · All Rights Reserved
    </footer>
    ...
    <script>
        (function() {
            ...
            console.log('Editing Employer:', {
                ...
                verified: '${employer.companyVerified}'
            });
        })();
    </script>

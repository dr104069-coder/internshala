...
<head>
    ...
    <title>Employer Details · SmartIntern Admin</title>
    ...
    <style>
        ...
        * {
        ...
        /* ========================================================
           EMPLOYER DETAILS CARD - MATCHING DASHBOARD STYLE
           ======================================================== */
        ...
        @media (max-width: 768px) {
            ...
            .btn-back-light { align-self: flex-start; }
        }
        ...
        <main class="main-panel">
            ...
            <div class="employer-details-card">
                ...
                <div class="details-header">
                    ...
                    <a href="listEmployer" class="btn-back-light">
                ...
                <div class="details-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info-row">
                                <span class="info-label"><i class="bi bi-building"></i> Company Name:</span>
                                <span class="info-value">${employer.companyName}</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-row">
                                <span class="info-label"><i class="bi bi-tag"></i> Company Type:</span>
                                <span class="info-value">${employer.companyType}</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-row">
                                ...
                                <span class="info-value">
                                    <a href="${employer.website}" target="_blank" class="company-link">
                                        ${employer.website} <i class="bi bi-box-arrow-up-right"></i>
                                    </a>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-row">
                                <span class="info-label"><i class="bi bi-geo-alt"></i> Company Address:</span>
                                <span class="info-value">${employer.companyAddress}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info-row">
                                <span class="info-label"><i class="bi bi-person-circle"></i> HR Name:</span>
                                <span class="info-value">${employer.hrName}</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-row">
                                <span class="info-label"><i class="bi bi-phone"></i> HR Mobile:</span>
                                <span class="info-value">${employer.hrMobile}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="info-row">
                                <span class="info-label"><i class="bi bi-check-circle"></i> Verified Status:</span>
                                <span class="info-value">
                                    <c:choose>
                        ...
                        <div class="col-md-4">
                            <div class="info-row">
                                <span class="info-label"><i class="bi bi-calendar"></i> Created Date:</span>
                                <span class="info-value">${employer.createdAt}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-row">
                                <span class="info-label"><i class="bi bi-person-badge"></i> Associated User:</span>
                                <span class="info-value">
                                    <c:if test="${not empty employer.user}">
                                        ${employer.user.firstName} ${employer.user.lastName} (ID: ${employer.user.userId})
                                    </c:if>
